...
class ChatReadRetrieveReadVisionApproach(ChatApproach):
    ...
    def system_message_chat_conversation(self):
        return """
        You are an intelligent assistant helping pre-sale team, BA summary business requirements, analyse, reference them based on data you and current user can have access to. 
